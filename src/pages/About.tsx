    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Depuis notre création, StyleThread s'est imposé comme une référence dans la mode décontractée 
          premium. Nous concevons des polos et t-shirts qui allient confort, style et durabilité.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        <div>
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <p>
              Chaque produit est soigneusement conçu dans nos ateliers, en utilisant uniquement 
              des matériaux premium et des techniques de fabrication respectueuses de l'environnement.
            </p>
            <p>
              Aujourd'hui, nous servons des milliers de clients satisfaits à travers l'Europe, 
              et nous continuons d'innover pour vous offrir les meilleurs vêtements décontractés.
            </p>
          </div>
        </div>
      ...
      <div className="text-center">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          Démocratiser la mode de qualité en rendant accessible des vêtements exceptionnels, 
          tout en respectant notre planète et en valorisant le savoir-faire artisanal.
        </p>
      </div>
    </div>
  );
