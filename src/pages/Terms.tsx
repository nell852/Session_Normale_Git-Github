      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Les prix sont indiqués en euros toutes taxes comprises. StyleThread se réserve le
                droit de modifier ses prix à tout moment, mais les produits seront facturés sur la
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Toute commande passée sur le site constitue un contrat de vente. La validation de
                  la commande implique l'acceptation des présentes conditions générales.
                </p>
                <p>
                  StyleThread se réserve le droit d'annuler toute commande en cas d'indisponibilité
                  du produit ou de problème concernant le règlement.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Les délais de livraison sont donnés à titre indicatif. Les produits sont expédiés
                  à l'adresse de livraison indiquée lors de la commande.
                </p>
                <p>
                  La livraison est gratuite pour toute commande supérieure à 75€ en France
                  métropolitaine.
                </p>
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  ...
                  état, avec tous les accessoires.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                ...
                contre les vices cachés. StyleThread s'engage à réparer ou remplacer tout produit
                défectueux.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                ...
                gestion des commandes. Vous disposez d'un droit d'accès, de rectification et de
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Les présentes conditions générales sont soumises au droit français. Tout litige sera
